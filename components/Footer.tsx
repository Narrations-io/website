      ...
      <div className="mx-auto max-w-[1200px] px-6 pb-10 pt-16 md:pt-20">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_2fr_1.4fr] lg:gap-10">
            ...
            <div className="mt-5 flex items-center gap-3">
              {SOCIALS.map(({ label, href, icon: Icon }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="flex h-11 w-11 items-center justify-center rounded-full border border-white/10 text-white/60 transition hover:border-white/30 hover:text-white"
                >
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-6 text-white/50">
              News from the private beta, new parts as they ship, and what
              we&rsquo;re learning about keeping a company&rsquo;s writing
              consistent.
            </p>
            <NewsletterForm
              variant="dark"
        ...
        <div className="mt-7 flex flex-col gap-3 border-t border-white/10 pt-5 text-[11px] text-white/40 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
          <span className="whitespace-nowrap">
            © Narrations 2024. All rights reserved.
          </span>

...
const inputClass =
  "h-11 w-full rounded-xl border border-white/12 bg-white/[0.03] px-4 text-base text-white placeholder:text-white/35 outline-none transition focus:border-green-500/50";
...
export default function ContactSection({
  ...
  subtitle = "See the editor in its private beta, scope a deployment inside your own infrastructure, or bring in an operator, and we'll route you to the right conversation.",
}: ContactSectionProps = {}) {
  ...
  const cards = [
    {
      icon: Presentation,
      title: "Platform demo",
      text: "An operator walks you through the editor in private beta: how a draft is checked against your rules, how a correction is kept, and which parts are still being built.",
      cta: (
        <Link
          href="/#book-a-demo"
    ...
    },
    {
      icon: ShieldCheck,
      title: "Enterprise AI",
      text: "For corporates, institutions and governments that need Narrations on their own servers or cloud, under their own keys, with approval gates, permissions and a full log.",
      cta: (
        <button
          type="button"
          ...
          className="inline-flex items-center gap-1.5 text-sm font-medium text-white transition hover:text-green-500"
        >
          Scope your deployment <ArrowRight className="h-4 w-4" />
        </button>
      ),
    },
  ];
            ...
            >
              ...
              <div className="mt-5">
                ...
                <select
                  ...
                  className="h-11 w-full appearance-none rounded-xl border border-white/12 bg-white/[0.03] px-4 text-base text-white outline-none transition focus:border-green-500/50"
                >
                  {INTERESTS.map((opt) => (
              ...
              <div className="mt-5">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-white/12 bg-white/[0.03] px-4 py-3 text-base text-white placeholder:text-white/35 outline-none transition focus:border-green-500/50"
                />
              </div>

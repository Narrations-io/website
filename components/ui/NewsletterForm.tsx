...
> = {
  dark: {
    ...
    form: "flex gap-2",
    input:
      "h-11 w-full min-w-0 flex-1 rounded-xl border border-white/15 bg-white/[0.03] px-4 text-base text-white placeholder:text-white/35 outline-none transition focus:border-green-500/50",
    button:
  ...
  light: {
    ...
    form: "flex gap-2",
    input:
      "h-11 w-full min-w-0 flex-1 rounded-xl border border-line bg-paper px-4 text-base text-ink-900 placeholder:text-ink-300 outline-none transition focus:border-green-500/50",
    button:

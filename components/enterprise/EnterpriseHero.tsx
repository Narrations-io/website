...
// AI dashboards inside the client's own infrastructure (deck §10).
    ...
    <section className="relative overflow-hidden bg-dbg text-white">
      ...
      <div className="relative mx-auto max-w-[1200px] px-6 py-24 md:py-28">
        ...
        <p className="mt-5 max-w-[62ch] text-base leading-7 text-[--d-text-mid] md:text-lg md:leading-8">
          For corporates, institutions and governments that can&rsquo;t send
          data to someone else&rsquo;s cloud. We install Narrations inside your
          infrastructure: the editor, your approved rules and the models, under
          your keys. Nothing goes live without a person&rsquo;s sign-off.
        </p>

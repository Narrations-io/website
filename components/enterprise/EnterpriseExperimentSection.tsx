...
// "FDO ships B" labels are free to use the short form. Keep
...
// The outcome labels are deliberately non-numeric. They were "80%" / "72%" under
// a "Success rate" caption — the only figures on the page, absent from the deck,
// and on a diagram about testing they read as a measured performance claim
// rather than illustrative chrome. To revert, swap outcomes back to
// ["80%", "72%"] and change OUTCOME_CAPTION to "Success rate".
const FLOW = {
  origin: "Agent",
  gate: "Operator tests",
  branches: ["Version B", "Version A"] as const,
  outcomes: ["Passed", "Held"] as const,
  result: "Operator ships B",
};

const OUTCOME_CAPTION = "Test result";
      ...
      <div className="mx-auto max-w-[1200px] px-6 py-24 md:py-28">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-ink-500">
            Every change is drafted and tested away from your live systems
            first. A person, at first an operator, then your own team, checks
            it before it runs, not after. The approval is recorded, so you can
            show who signed off.
          </p>
        </div>

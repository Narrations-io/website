...
function Section({
  ...
  return (
    <section className="border-t border-white/[0.06] py-20 md:py-[120px]">
        ...
        <header className="relative grid gap-12 pb-[180px] pt-12 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            <p className="max-w-[380px] text-[15px] leading-[1.65] text-white/55">
              The kit includes the wordmark lockup, the mark, colour tokens,
        ...
        <Section
          ...
          body={
            <>
              ...
              <p className="mt-5">
                The platform&rsquo;s parts (Content, Marketing, Operations,
                Customer Support, AI Studio and the Ledger) are written as
                proper nouns. Where a name contains an <em>n</em>, that letter
                is replaced by the Narrations mark in UI, sized to cap-height,
                e.g.{" "}
                ...
                . Customer Support, AI Studio and Ledger have no <em>n</em>, so
                they set as plain text. Display use only, never in body copy.
              </p>
            </>
          }
        />
        ...
        >
          ...
          <div className="mb-12 grid gap-3 md:grid-cols-2">
            {LOGO_FILES.map((f) => (
              <div
                key={f.file}
                className={`flex aspect-[3/2] items-center justify-center rounded-[20px] p-6 ${
                  f.dark
                    ? "bg-[#07140F] border border-white/10"
                    : "bg-white"
                }`}
              >
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {MARK_FILES.map((f) => (
              <div
                key={f.file}
                className={`flex aspect-[3/2] items-center justify-center rounded-[20px] ${
                  f.dark
                    ? "bg-[#07140F] border border-white/10"
                    : "bg-white"
                }`}

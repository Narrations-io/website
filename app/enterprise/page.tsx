...
export const metadata: Metadata = {
  title: "Enterprise AI: inside your own infrastructure | Narrations",
  description:
    "Run Narrations inside your own infrastructure: your data stays put, every action waits for sign-off, and every draft, edit and approval is logged.",
};
